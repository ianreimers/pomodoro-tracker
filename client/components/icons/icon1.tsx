...
export default function Icon1({ className = "w-25 h-25" }: { className?: string }) {
	//shape-rednering="crispEdges"
	return (
		<>
			<svg version="1.1" className={className} viewBox="0 0 16 17" fill={primaryColor} xmlns="http://www.w3.org/2000/svg" shapeRendering="crispEdges">
