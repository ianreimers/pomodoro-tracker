...
export default function Icon4({ className = "w-25 h-25" }: { className?: string }) {
	//shape-rednering="crispEdges"
	return (
		<svg version="1.1" className={className} viewBox="0 0 15 18" fill={primaryColor} xmlns="http://www.w3.org/2000/svg" shape-rendering="crispEdges">
